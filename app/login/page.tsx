  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-8">
      <div className="bg-white rounded-2xl border p-8 w-full max-w-[380px]">
        ...
        <input className="mt-6 w-full h-12 rounded-xl border px-4 bg-gray-50" placeholder="you@company.com" defaultValue="baigamatsinquiries@gmail.com" />
        <input type="password" className="mt-3 w-full h-12 rounded-xl border px-4 bg-gray-50" placeholder="Password" defaultValue="12345678" />
        <Link href="/forgot-password" className="text-xs underline mt-3 block">Forgot password?</Link>
        <button onClick={()=>router.push('/dashboard')} className="mt-4 w-full h-12 bg-black text-white rounded-xl hover:bg-gray-800">Sign In ?</button>
